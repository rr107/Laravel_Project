...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet"
        href="{{ asset('backend/asset/fonts/material-icon/css/material-design-iconic-font.min.css') }}">
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="signup-image">
                        <figure><img src="{{ asset('backend/asset/images/signup-image.jpg') }}" alt="sign up image">
                        </figure>
